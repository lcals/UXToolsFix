...
public static class UIColorConfig
{
    ...
    public static readonly string ColorConfigDefPath = RootPath + "UX-GUI-Feature/UIColorConfig/UIColor/";
    public static readonly string ColorConfigDefName = "UIColorGenDef.cs";
}